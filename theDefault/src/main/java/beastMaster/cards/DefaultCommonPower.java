...
import beastMaster.powers.CommonPower;
...
public class DefaultCommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = BeastMasterMod.makeID(DefaultCommonPower.class.getSimpleName());
